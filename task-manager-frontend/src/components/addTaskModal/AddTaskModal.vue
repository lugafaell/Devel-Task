      ...
      <form @submit.prevent="submitTask">
        ...
        <div class="form-group">
          ...
          <textarea
            ...
            placeholder="Type your task's description here..."
            required
          ></textarea>
        </div>
...
export default {
  ...
  methods: {
    ...
    submitTask() {
      const startDate = new Date(this.taskStartDate).toLocaleDateString();
      const deadline = new Date(this.taskDeadline).toLocaleDateString();
      const newTask = {
        title: this.taskName,
